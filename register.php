<?php 
	...
	if ($_POST['_action_'] == FALSE) {
		...
		<form action="" id="registration_form" name="registration_form" method="POST">
			...
			<input type="text" id="lastname" name="lastname" placeholder="Your last natme.." required><br>
			...
			<input type="text" id="username" name="username" pattern=".{5,10}" placeholder="Username.." required><br><br>
